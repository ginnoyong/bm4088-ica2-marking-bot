"""Static help copy shown in the "How to use this bot" dialog."""
...
- Open the Power BI file, notebook, or presentation itself - it works from what you paste, describe, or upload, never by accessing files directly
- It gives a recommended band and mark with reasoning, never a final grade - that's always your call
"""
